...
// metronome.bpm(number)                                // Set the BPM (6 - 300). Returns the current BPM.
// metronome.bpm()                                      // Returns the current BPM.

// metronome.frequency(number)                          // Set the click frequency (20 - 20500). Returns the current frequency.
// metronome.frequency()                                // Returns the current frequency.

// metronome.volume(number)                             // Set the click volume (0 - 100). Returns the current volume.
...
// metronome.hide()                                     // Hide the UI widget. Not applicable in headless mode.
// metronome.show()                                     // Show the UI widget. Not applicable in headless mode.
